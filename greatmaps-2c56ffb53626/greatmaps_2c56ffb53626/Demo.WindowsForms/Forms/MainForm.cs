...
namespace Demo.WindowsForms
{
   public partial class MainForm : Form
   {
      ...
      public MainForm()
      {
         ...
         GDSM = new GridDataSetManager();

         GridDataPoints GTest = new GridDataPoints("p28d_va");
         //GTest.fillME();
         //GDSM.DataSets.Add(GTest.DataSetName, GTest);
         OP = new OverlayProcessor(ref MainMap, ref GDSM);
